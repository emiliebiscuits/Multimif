<div id="load_div">
    <img src='<c:url value="/resources/images/loader.gif"/>'></img>
</div>
...
<div class="row" style="padding: 10px; border-bottom: darkgray 2px solid">
    ...
    <div class="pull-right" style="margin-top: 10px; margin-right: 15px">   
        <c:choose>
            <c:when test="${accountid != null && accountid != ''}">
                <div id="log_div" style="display:none">
                    <a href="" data-toggle="modal" data-target="#connexion_div">log-in</a> | 
                    <a href="/multimif/inscription.htm">registration</a>
                </div>
                <div id="account_div">
                    <a href="/multimif/account/${accountid}"><i class="glyphicon glyphicon-user"></i> <span>${pseudo}</span> (my account)</a> | 
                    <form id="disconnect" style="display:inline" action="/multimif/logout.htm" method="GET">
                    </form>
                    <a href="#" onclick="$('#disconnect').submit()">log-out</a>
                </div>
            </c:when>
            <c:otherwise>
                <div id="log_div">
                ...
                <div id="account_div" style="display: none">
                    ...
                    <a href=""><i class="glyphicon glyphicon-user"></i> <span></span> (my account)</a> | 
                    <form id="disconnect" style="display:inline" action="/multimif/logout.htm" method="GET">
                    </form>
                    <a href="#" onclick="$('#disconnect').submit()">log-out</a>
                </div>
    ...
    <h4><a href="/multimif">SYMPOZER Ze Back-End</a></h4>
        ...
        <div class="modal-dialog" style="width: 500px">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="/multimif/inscription.htm">No account yet?</a> 
